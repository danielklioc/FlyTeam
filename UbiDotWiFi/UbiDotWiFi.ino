//  This code takes readings from a sensor and posts them via Ubidots.com
...
const int sleep_time = 5;  // Time to sleep (in seconds) between posts to Ubidots
WiFiClient client;
...
String variable_id1 = "59e218db76254275000af386";
String variable_id2 = "59e1fb36c03f972b08e1b04a";
...
String token = "A1E-82FLoYcaLlS26kAHpBVasOTUI8hBxS";

// We'll also initialize the values for our Wi-Fi network
const char* ssid = "HackUPC-Wifi";
const char* password = "h4ckUPC0/";
...
void loop()
{
        ...
        if (Serial.available() > 0) {
              ...
              if ((incomingByte.substring(0,4)) == ("START")){
                for (int i = 5; i < incomingByte.length(); i++) {
